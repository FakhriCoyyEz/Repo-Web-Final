...
export default function ProgrammingPage() {
  ...
  const bph = [
    { no: "000000000003", name: "????", position: "Kepala Divisi", photo: "/Assets/cewek.png" },
    { no: "000000000004", name: "kaysan", position: "Wakil Kepala Divisi", photo: "/Assets/cowok.png" }
  ...
  return (
    <div className="loaded">
      ...
      <section className="min-h-[40vh] md:min-h-[60vh] flex items-center justify-center p-4 md:p-5 " id="index">
        <h1 className="hero-title text-[8vw] font-black font-display leading-none text-transparent bg-clip-text bg-gradient-to-r from-white to-[#6b8afd] tracking-tighter text-center uppercase flex flex-wrap items-center justify-center break-words w-full max-w-full overflow-hidden px-4">
          PROGRAMMING
        </h1>
      </section>
      ...
      <div className="flex justify-center my-16">
        ...
        <a
          href="https://docs.google.com/forms/d/e/1FAIpQLSdYWdh40aiv9_lUhajd79E_k1KZay6nxLViNb1IgMNuA_aiZQ/viewform?usp=header"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[rgba(107,138,253,0.1)] text-white py-3 px-6 rounded-3xl font-bold hover:bg-sky-600 transition-colors"
        >
          Pengumpulan Proyek Divisi Programming
        </a>
      </div>
      <footer>
